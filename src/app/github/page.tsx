...
const githubPrompts: Prompt[] = [
  {
    id: "github-1",
    content:
      "Create a comprehensive README.md template for an AI-powered web application. Include sections for features, installation, usage, API documentation, and contribution guidelines.",
    source: "github",
    creator: "AI",
    usage_count: 156,
    tags: ["documentation", "README", "template", "AI"],
    created_at: new Date().toISOString(),
  },
  {
    id: "github-2",
    content:
      "Generate a GitHub Actions workflow for automated testing, building, and deploying a Next.js application to Vercel with environment-specific configurations.",
    source: "github",
    creator: "AI",
    usage_count: 89,
